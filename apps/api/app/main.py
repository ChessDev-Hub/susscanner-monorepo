...
def scan(req: ScanRequest):
    ...
    # Lazy import so the API still boots even if scanner isn't present yet.
    SusScanner = None
    analyze_user_fn = None
    try:
        # NOTE: relative imports because main.py and scanner.py are both in app/
    ...
    # pass through optional env if used by your scanner
    ...
    if analyze_user_fn:
        ...
        # instantiate and call whichever method your scanner exposes
        ...
        if hasattr(scanner, "analyze_user"):
            ...
            raise HTTPException(status_code=500, detail="scanner lacks analyze_user/analyze_player")
